...
#define PASSWORD "GeorgeP@1927"

// Spotify API credentials
#define CLIENT_ID "a0cf0291e31443b79abcb43a06ce3d56"
#define CLIENT_SECRET "d9ab9206b81b432b880e3ce6f3c984bd"
//#define REDIRECT_URI "http://10.89.21.22/callback"
//#define REDIRECT_URI "http://10.89.5.83/callback"
#define REDIRECT_URI "http://10.89.2.91/callback"
...
//int buttonPins[] = {D1, D2, D0, D6};  // GPIO 5 for D1, GPIO 4 for D2, GPIO 16 for D0, and GPIO 12 for D6
...
int buttonPins[] = {D1, D2, RX, D6};  // GPIO 5 for D1, GPIO 4 for D2, GPIO 16 for D0, and GPIO 12 for D6
//int buttonPins[] = {5, 4, 16, 12};  // GPIO 5 for D1, GPIO 4 for D2, GPIO 16 for D0, and GPIO 12 for D6
